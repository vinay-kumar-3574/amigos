...
const DetailPage = ({ slug, detailPages, productCards }) => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="w-full bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 text-white py-12 md:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <motion.button
            ...
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 mb-8 text-neutral-300 hover:text-white transition-colors"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-neutral-300 bg-clip-text text-transparent">
            ...
            >
              <div className="relative bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-2xl p-8 shadow-2xl">
                <img
                  src={product.image}
                  alt={product.title}
                  className="w-full h-auto rounded-lg object-contain"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-neutral-900/50 to-transparent rounded-2xl pointer-events-none" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="w-full py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.h2
            ...
            transition={{ duration: 0.6 }}
            className="text-4xl font-bold text-center mb-12 text-neutral-800"
          >
            Specifications
          </motion.h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {dimensionSpecs.length > 0 && (
              ...
              >
                <h3 className="text-2xl font-bold mb-6 text-neutral-800 flex items-center gap-2">
